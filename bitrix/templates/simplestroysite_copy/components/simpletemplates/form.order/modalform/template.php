...
<div style="text-align:center"><button type="button" class="btn smt-btn smt-btn-sm" data-toggle="modal" data-target="#exampleModal">Отправить заявку</button></div>
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="smt-header smt-header-underline-left h4" id="exampleModalLabel">Отправить заявку</h4>
