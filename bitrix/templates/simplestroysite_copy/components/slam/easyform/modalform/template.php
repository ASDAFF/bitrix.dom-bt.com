...
<?if($arParams['NAME_MODAL_BUTTON']):?>
    <button type="button" class="btn smt-btn smt-btn-lg" data-toggle="modal" data-target="#modal<?=$FORM_ID?>"><?=$arParams['NAME_MODAL_BUTTON']?></button>
<?endif;?>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <? if($arParams['FORM_NAME']): ?>
                        <div class="title smt-header smt-header-underline-left h4"><?=$arParams['FORM_NAME']?></div>
                    <? endif?>
                </div>
                            ...
                            <div class="row">
                                ...
                                if(!empty($arResult['FORM_FIELDS'])):
                                    foreach($arResult['FORM_FIELDS'] as $fieldCode => $arField):
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    <? if(!$arParams['HIDE_FIELD_NAME']): ?>
                                                        <label class="control-label text-uppercase" for="<?=$arField['ID']?>"><?=$arField['TITLE']?></label>
                                                    <? endif; ?>
                                                    <div>
                                        ...
                                        <?elseif($arField['TYPE'] == 'radio' || $arField['TYPE'] == 'checkbox'):?>
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    <? if(!$arParams['HIDE_FIELD_NAME']): ?>
                                                        <label class="control-label text-uppercase"><?=$arField['TITLE']?>&nbsp;</label>
                                                    <? endif; ?>
                                        ...
                                        <?elseif($arField['TYPE'] == 'select'):?>
                                            <div class="col-xs-12 switch-select">
                                                <div class="form-group switch-parent">
                                                    <? if(!$arParams['HIDE_FIELD_NAME']): ?>
                                                        <label for="<?=$arField['ID']?>" class="control-label text-uppercase"><?=$arField['TITLE']?></label>
                                                    <? endif; ?>
                                                ...
                                                <?if($arField['SET_ADDITION_SELECT_VAL']):?>
                                                    <div class="form-group switch-child hidden">
                                                        <? if(!$arParams['HIDE_FIELD_NAME']): ?>
                                                            <label class="control-label text-uppercase" for="<?=$arField['SET_ADDITION_SELECT_ID']?>"><?=$arField['TITLE']?></label>
                                                        <? endif; ?>
                                                        <div class="row">
                                                            <div class="col-xs-9">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <? if(!$arParams['HIDE_FIELD_NAME']): ?>
                                                <label for="<?=$FORM_ID?>-captchaValidator" class="control-label text-uppercase"><?=htmlspecialcharsBack($arParams['CAPTCHA_TITLE'])?></label>
                                            <? endif; ?>
                                ...
                                <?endif;?>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <?endif;?>
                                        <button type="submit" class="btn btn-block smt-btn smt-btn_shadow text-uppercase" data-default="<?=$arParams['FORM_SUBMIT_VALUE']?>"><?=$arParams['FORM_SUBMIT_VALUE']?></button>
                                    </div>
                                <?endif;?>
                            </div>
                        </form>
                ...
                <div class="modal-content">
                    <div class="modal-header clearfix">
                        ...
                        <? if($arParams['TITLE_SHOW_MODAL'] || $arParams['FORM_NAME']): ?>
                            <div class="title smt-header smt-header-underline-left h4"><?=$arParams['TITLE_SHOW_MODAL'] ? : $arParams['FORM_NAME']?></div>
                        <? endif?>
                    </div>
                    <div class="modal-body">
