...
<?$countSection = 0;?>
	...
	<div class="tab-pane fade<?if($count==0):?> active in<?endif?>" role="tabpanel" id="smt-tab-<?=$arSection["ID"]?>">
		...
		<div class="smt-blog-list"  id="<?=$this->GetEditAreaId('section_'.$arSection['ID']);?>">
			...
			<?foreach($arSection["ITEMS"] as $arItem):?>
				...
				<?endif?>
				<div class="smt-blog-item<?if($arParams["LINE_ELEMENT_COUNT"] == 1):?> smt-blog-item_line<?endif?> smt-blog-item_background" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
