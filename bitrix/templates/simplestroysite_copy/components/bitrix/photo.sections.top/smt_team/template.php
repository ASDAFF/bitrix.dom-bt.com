...
<?$countSection = 0;?>
	<?foreach($arResult["SECTIONS"] as $arSection):?>
		...
		<div class="smt-widget smt-widget_margin">
			<?if($arParams["SECTION_DISPLAY_NAME"] == "Y"):?>
			<h2 class="<?if(strlen($arParams["SECTION_ADDITIONAL_CLASS"])>0):?><?=$arParams["SECTION_ADDITIONAL_CLASS"]?><?else:?>h2 smt-header smt-header-underline-left<?endif?>" id="<?=$this->GetEditAreaId('section_'.$arSection['ID']);?>">
			...
			<?if($arParams["SECTION_DISPLAY_PICTURE"] == "Y"):?>
				...
				<?endif?>
				<img src="<? echo ($arSection['PREVIEW_PICTURE']['SRC'])?$arSection['PREVIEW_PICTURE']['SRC']:$arSection['PICTURE']['SRC']; ?>" class="smt-image__image smt-img-thumbnail">
