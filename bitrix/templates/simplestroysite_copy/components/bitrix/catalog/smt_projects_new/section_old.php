...
<div class="row">
	<?if($isSidebar):?>
	<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3<?if($isSidebarRight):?> col-md-push-9 col-lg-push-9<?endif?>">
	...
	<?endif?>
	<?if($isSidebar):?>
	<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9<?if($isSidebarRight):?> col-md-pull-3 col-lg-pull-3<?endif?>">
	<?else:?>
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<?endif?>
		<?if($arParams["SHOW_SECTIONS_SECTION"] == "Y"):?>
			<?$APPLICATION->IncludeComponent(
