...
<?endif;?>
	...
	<input class="btn smt-btn smt-form__submit" type="submit" value="<?=GetMessage("SEARCH_GO")?>" />
...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<div class="smt-widget clearfix">
	<div class="smt-cart-list smt-margin-top-24">
	<?foreach($arResult["SEARCH"] as $arItem):?>
		<div class="smt-cart-item smt-cart-item_bordered-full">
...
<?else:?>
	<hr class="smt-divider">
	<div class="clearfix smt-alert smt-alert_warning"><?=(GetMessage("SEARCH_NOTHING_TO_FOUND"));?></div>
<?endif;?>
</div>