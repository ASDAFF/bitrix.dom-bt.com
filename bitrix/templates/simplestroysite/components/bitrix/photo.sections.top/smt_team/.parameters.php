...
$arTemplateParameters["PICTURE_RESIZE_SOURCE"] = array(
	...
	"VALUES" => array("DETAIL_PICTURE" => "DETAIL_PICTURE", "PREVIEW_PICTURE" => "PREVIEW_PICTURE", "PICTURE" => "PICTURE"),
	"HIDDEN" => (isset($arCurrentValues['PICTURE_RESIZE']) && $arCurrentValues['PICTURE_RESIZE'] == 'N' ? 'Y' : 'N'),
);
...
$arTemplateParameters["SECTION_DISPLAY_NAME"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_DISPLAY_NAME"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
);

$arTemplateParameters["SECTION_DISPLAY_PICTURE"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_DISPLAY_PICTURE"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
);

$arTemplateParameters["SECTION_DISPLAY_PREVIEW_TEXT"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_DISPLAY_PREVIEW_TEXT"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
);

$arTemplateParameters["SECTION_DISPLAY_DESCRIPTION"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_DISPLAY_DESCRIPTION"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
);

$arTemplateParameters["SECTION_DISPLAY_BUTTON"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_DISPLAY_BUTTON"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
);

$arTemplateParameters["SECTION_DISPLAY_LINK"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_DISPLAY_LINK"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
);

$arTemplateParameters["SECTION_ADDITIONAL_CLASS"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_ADDITIONAL_CLASS"),
	"TYPE" => "STRING",
);

$arTemplateParameters["SECTION_PICTURE_RESIZE"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_PICTURE_RESIZE"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y",
	"REFRESH" => "Y",
);

$arTemplateParameters["SECTION_PICTURE_RESIZE_MODE"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_PICTURE_RESIZE_MODE"),
	"MULTIPLE" => "N",
	"TYPE" => "LIST",
	"DEFAULT" => BX_RESIZE_IMAGE_EXACT,
	"VALUES" => array(BX_RESIZE_IMAGE_EXACT => "BX_RESIZE_IMAGE_EXACT", BX_RESIZE_IMAGE_PROPORTIONAL=>"BX_RESIZE_IMAGE_PROPORTIONAL",BX_RESIZE_IMAGE_PROPORTIONAL_ALT=>"BX_RESIZE_IMAGE_PROPORTIONAL_ALT"),
	"HIDDEN" => (isset($arCurrentValues['SECTION_PICTURE_RESIZE']) && $arCurrentValues['SECTION_PICTURE_RESIZE'] == 'N' ? 'Y' : 'N'),
);

$arTemplateParameters["SECTION_PICTURE_RESIZE_SOURCE"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_PICTURE_RESIZE_SOURCE"),
	"MULTIPLE" => "N",
	"TYPE" => "LIST",
	"DEFAULT" => "PICTURE",
	"VALUES" => array("PICTURE" => "PICTURE", "DETAIL_PICTURE" => "DETAIL_PICTURE"),
	"HIDDEN" => (isset($arCurrentValues['SECTION_PICTURE_RESIZE']) && $arCurrentValues['SECTION_PICTURE_RESIZE'] == 'N' ? 'Y' : 'N'),
);

$arTemplateParameters["SECTION_PICTURE_RESIZE_WIDTH"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_PICTURE_RESIZE_WIDTH"),
	"TYPE" => "STRING",
	"DEFAULT" => "640",
	"HIDDEN" => (isset($arCurrentValues['SECTION_PICTURE_RESIZE']) && $arCurrentValues['SECTION_PICTURE_RESIZE'] == 'N' ? 'Y' : 'N'),
);

$arTemplateParameters["SECTION_PICTURE_RESIZE_HEIGHT"] = array(
	"PARENT" => "ADDITIONAL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SECTION_PICTURE_RESIZE_HEIGHT"),
	"TYPE" => "STRING",
	"DEFAULT" => "480",
	"HIDDEN" => (isset($arCurrentValues['SECTION_PICTURE_RESIZE']) && $arCurrentValues['SECTION_PICTURE_RESIZE'] == 'N' ? 'Y' : 'N'),
);