...
<?$countSection = 0;?>
	<ul class="nav nav-pills nav-stacked smt-nav-tabs smt-nav-tabs_vertical col-md-3" role="tablist">
	...
	<div class="tab-content smt-tab-content smt-tab-content_vertical col-md-9">
	<?foreach($arResult["SECTIONS"] as $count=>$arSection):?>
		<?
