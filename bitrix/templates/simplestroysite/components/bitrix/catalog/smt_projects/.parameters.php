...
$arTemplateParameters['SIDEBAR_SECTIONS_SHOW'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('SMT_CPT_SIDEBAR_SECTIONS_SHOW'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'Y',
);
...
$arTemplateParameters['SIDEBAR_SECTION_SHOW'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('SMT_CPT_SIDEBAR_SECTION_SHOW'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'Y',
);
...
$arTemplateParameters['SIDEBAR_DETAIL_SHOW'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('SMT_CPT_SIDEBAR_DETAIL_SHOW'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N',
);
...
$arTemplateParameters['SIDEBAR_PATH'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('SMT_CPT_SIDEBAR_PATH'),
	'TYPE' => 'STRING',
);

$arTemplateParameters['SIDEBAR_RIGHT'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('SMT_CPT_SIDEBAR_RIGHT'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N',
);
...
$arTemplateParameters["DETAIL_CURRENCY"] = array(
	'PARENT' => 'DETAIL_SETTINGS',
...
$arTemplateParameters["DETAIL_CURRENCY_DECIMALS"] = array(
	"PARENT" => "DETAIL_SETTINGS",
...
$arTemplateParameters["DETAIL_CURRENCY_DECIMALS_POINT"] = array(
	"PARENT" => "DETAIL_SETTINGS",
...
$arTemplateParameters["DETAIL_CURRENCY_THOUSANDS_SEP"] = array(
	"PARENT" => "DETAIL_SETTINGS",
...
$arTemplateParameters["DETAIL_PRICE_HEADER"] = array(
	'PARENT' => 'DETAIL_SETTINGS',
...
$arTemplateParameters["DETAIL_SMT_SLIDER_GALLERY"] = array(
	"PARENT" => "DETAIL_SETTINGS",
...
$arTemplateParameters["DETAIL_SMT_SLIDER_GALLERY_ITEMS"] = array(
	"PARENT" => "DETAIL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SLIDER_ITEMS"),
	"TYPE" => "STRING",
	"HIDDEN" => (isset($arCurrentValues['DETAIL_SMT_SLIDER_GALLERY']) && $arCurrentValues['DETAIL_SMT_SLIDER_GALLERY'] == 'N' ? 'Y' : 'N'),
);

$arTemplateParameters["DETAIL_SMT_SLIDER_GALLERY_MARGIN"] = array(
	"PARENT" => "DETAIL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SLIDER_MARGIN"),
	"TYPE" => "STRING",
	"HIDDEN" => (isset($arCurrentValues['DETAIL_SMT_SLIDER_GALLERY']) && $arCurrentValues['DETAIL_SMT_SLIDER_GALLERY'] == 'N' ? 'Y' : 'N'),
...
$arTemplateParameters["DETAIL_SMT_SLIDER_GALLERY_NAV"] = array(
	"PARENT" => "DETAIL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SLIDER_NAV"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "",
...
$arTemplateParameters["DETAIL_SMT_SLIDER_GALLERY_DOTS"] = array(
	"PARENT" => "DETAIL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SLIDER_DOTS"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "",
...
$arTemplateParameters["DETAIL_SMT_SLIDER_GALLERY_VERTICAL_ALIGN"] = array(
	"PARENT" => "DETAIL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SLIDER_VERTICAL_ALIGN"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "",
...
$arTemplateParameters["DETAIL_SMT_SLIDER_GALLERY_RESPONSIVE"] = array(
	"PARENT" => "DETAIL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SLIDER_RESPONSIVE"),
	"TYPE" => "STRING",
	"MULTIPLE" => "Y",
...
if (!empty($arCurrentValues['DETAIL_SMT_SLIDER_GALLERY_RESPONSIVE']))
{
	$values = array();
	foreach ($arCurrentValues['DETAIL_SMT_SLIDER_GALLERY_RESPONSIVE'] as $code=>$value)
	{
		if (strlen($value) > 0) {
			$arTemplateParameters["DETAIL_SMT_SLIDER_GALLERY_RESPONSIVE_ITEMS_" . $code] = array(
				"PARENT" => "DETAIL_SETTINGS",
				"NAME" => GetMessage("SMT_BPSP_SLIDER_RESPONSIVE_ITEMS") . $value,
				"TYPE" => "STRING",
				"HIDDEN" => (isset($arCurrentValues['DETAIL_SMT_SLIDER_GALLERY']) && $arCurrentValues['DETAIL_SMT_SLIDER_GALLERY'] == 'N' ? 'Y' : 'N'),
			);
			$arTemplateParameters["DETAIL_SMT_SLIDER_GALLERY_RESPONSIVE_CUSTOM_" . $code] = array(
				"PARENT" => "DETAIL_SETTINGS",
				"NAME" => GetMessage("SMT_BPSP_SLIDER_RESPONSIVE_CUSTOM") . $value,
				"TYPE" => "STRING",
				"HIDDEN" => (isset($arCurrentValues['DETAIL_SMT_SLIDER_GALLERY']) && $arCurrentValues['DETAIL_SMT_SLIDER_GALLERY'] == 'N' ? 'Y' : 'N'),
...
$arTemplateParameters["DETAIL_SMT_SLIDER_GALLERY_CUSTOM"] = array(
	"PARENT" => "DETAIL_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_SLIDER_CUSTOM"),
	"TYPE" => "STRING",
	"HIDDEN" => (isset($arCurrentValues['DETAIL_SMT_SLIDER_GALLERY']) && $arCurrentValues['DETAIL_SMT_SLIDER_GALLERY'] == 'N' ? 'Y' : 'N'),
...
$arTemplateParameters["LIST_CURRENCY"] = array(
	'PARENT' => 'LIST_SETTINGS',
	"NAME" => GetMessage("SMT_BPSP_CURRENCY_PARAMETER_NAME"),
	"TYPE" => "STRING",
	"DEFAULT" => GetMessage("SMT_BPSP_CURRENCY_PARAMETER_VALUE"),
...
$arTemplateParameters["LIST_CURRENCY_DECIMALS"] = array(
	"PARENT" => "LIST_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_CURRENCY_DECIMALS"),
	"TYPE" => "STRING",
	"DEFAULT" => "",
...
$arTemplateParameters["LIST_CURRENCY_DECIMALS_POINT"] = array(
	"PARENT" => "LIST_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_CURRENCY_DECIMALS_POINT"),
	"TYPE" => "STRING",
	"DEFAULT" => ".",
...
$arTemplateParameters["LIST_CURRENCY_THOUSANDS_SEP"] = array(
	"PARENT" => "LIST_SETTINGS",
	"NAME" => GetMessage("SMT_BPSP_CURRENCY_THOUSANDS_SEP"),
	"TYPE" => "STRING",
	"DEFAULT" => " ",
...
$arTemplateParameters["LIST_PRICE_HEADER"] = array(
	'PARENT' => 'LIST_SETTINGS',
	"NAME" => GetMessage("SMT_BPSP_PRICE_HEADER_PARAMETER_NAME"),
	"TYPE" => "STRING",
	"DEFAULT" => GetMessage("SMT_BPSP_PRICE_HEADER_PARAMETER_VALUE"),
