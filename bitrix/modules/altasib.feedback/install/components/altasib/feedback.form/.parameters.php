...
<div style="background-color:#fff;padding:0;border-top:1px solid #8E8E8E;border-bottom:1px solid #8E8E8E;margin-bottom:15px;"><div style="background-color:#8E8E8E;height:30px;padding:7px;border:1px solid #fff">
        <a href="http://www.is-market.ru" target="_blank"><img src="/bitrix/components/altasib/feedback.form/images/is-market.gif" style="float:left;margin-right:15px;" border="0" /></a>
...
if($arCurrentValues["ALX_LINK_POPUP"] == "Y")
{
        ...
        $arComponentParameters["PARAMETERS"]["ALX_IBLOCK_ELEMENT_LINK"] = array(
                "PARENT" => "POPUP",
                "NAME" => GetMessage("ALX_IBLOCK_ELEMENT_LINK"),
                "TYPE" => "STRING",
                "DEFAULT" => "",
                "COLS" => 50,
        );
        $arComponentParameters["PARAMETERS"]["ALX_POPUP_TITLE"] = array(
                "PARENT" => "POPUP",
                "NAME" => GetMessage("ALX_POPUP_TITLE"),
                "TYPE" => "STRING",
                "DEFAULT" => "",
                "COLS" => 50,
        );
