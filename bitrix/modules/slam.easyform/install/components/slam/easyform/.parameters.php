...
if ($arCurrentValues['USE_CAPTCHA'] == 'Y') {
    ...
    $arComponentParameters['PARAMETERS']['CAPTCHA_ERROR'] = array(
        'NAME' => Loc::getMessage('SLAM_EASYFORM_FIELD_CAPTCHA_ERROR'),
        'TYPE' => 'STRING',
...
if (empty($arCurrentValues['ENABLE_SEND_MAIL']) || $arCurrentValues['ENABLE_SEND_MAIL'] != 'N') {
    ...
    $arComponentParameters['PARAMETERS']['REPLACE_FIELD_FROM'] = array(
        'PARENT' => 'MAIL',
        'NAME' => Loc::getMessage('SLAM_EASYFORM_REPLACE_FIELD_FROM'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
    );
    ...
    $arComponentParameters['PARAMETERS']['WRITE_MESS_FILDES_TABLE'] = array(
        'NAME' => Loc::getMessage('SLAM_EASYFORM_WRITE_MESS_FILDES_TABLE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'N',
        'PARENT' => 'MAIL',
