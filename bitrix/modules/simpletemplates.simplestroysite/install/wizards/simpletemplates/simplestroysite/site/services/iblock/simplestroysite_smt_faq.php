...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/simplestroysite_smt_faq.xml";
$iblockCode = "simplestroysite_smt_faq_" . WIZARD_SITE_ID;
$iblockCodeOriginal = "simplestroysite_smt_faq";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."company/faq/index.php", array("SMT_FAQ_IBLOCK_ID" => $iblockID));;
